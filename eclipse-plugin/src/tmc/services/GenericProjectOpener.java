...
public class GenericProjectOpener implements ProjectOpener {
    ...
    private void openMavenProject(Project project, ProjectType projectType) throws CoreException, IOException {
        ...
        new MavenProjectOpener(FileUtil.append(project.getRootPath(), projectType.getBuildFile())).importAndOpen();

    }

    private void openAntProject(Project project, ProjectType projectType) throws CoreException {
        new AntProjectOpener(FileUtil.append(project.getRootPath(), ".project")).importAndOpen();
