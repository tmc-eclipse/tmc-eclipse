...
public class ProcessRunner implements Callable<ProcessResult> {
    ...
    public ProcessResult call() throws Exception {
        ...
        OutputStream out = stdoutBuf;
        OutputStream err = stderrBuf;
        ...
        try {
            ...
            Map<String, String> destroyEnv = Collections.singletonMap(PROCESS_TREE_IDENTIFIER_NAME,
                    processTreeIdentifier);
            process.destroy();
            throw e;
        }
