...
public class ReceivedCodeReviewDialog extends Dialog {
	...
	private void createContents() {
		shlCodeReview = new Shell(getParent(), SWT.DIALOG_TRIM
		...
		lblCodeReview.setFont(SWTResourceManager.getFont(
				"Microsoft Sans Serif", 12, SWT.BOLD));
		...
		lblNewLabel.setFont(SWTResourceManager.getFont("Microsoft Sans Serif",
				12, SWT.NORMAL));
		...
		btnMarkAsRead.setFont(SWTResourceManager.getFont(
				"Microsoft Sans Serif", 12, SWT.NORMAL));
		btnMarkAsRead.setText("Mark as read");

		txtHyio = new Text(shlCodeReview, SWT.WRAP | SWT.H_SCROLL | SWT.CANCEL
				| SWT.MULTI);
