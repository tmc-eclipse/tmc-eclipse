...
public class CodeReviewRequestDialog extends Dialog {
	...
	private void createContents() {
		...
		Label lblRequestingCodeReview = new Label(shlConfirmCodeReview,
				SWT.NONE);
		lblRequestingCodeReview.setFont(SWTResourceManager.getFont(
				"Microsoft Sans Serif", 11, SWT.BOLD));
		lblRequestingCodeReview.setBounds(10, 10, 394, 24);
		lblRequestingCodeReview
				.setText("Requesting code review for viikko1-002.heimaailma");

		Label lblMessageForThe = new Label(shlConfirmCodeReview, SWT.NONE);
		lblMessageForThe.setFont(SWTResourceManager.getFont("MS Sans Serif",
				11, SWT.NORMAL));
		...
		txtKattokaaMunParasta.setFont(SWTResourceManager.getFont("Tahoma", 11,
				SWT.NORMAL));
