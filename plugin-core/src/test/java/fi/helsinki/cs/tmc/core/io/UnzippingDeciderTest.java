...
import fi.helsinki.cs.tmc.core.io.zipper.unzippingdecider.DefaultUnzippingDecider;
import fi.helsinki.cs.tmc.core.io.zipper.unzippingdecider.MavenUnzippingDecider;
import fi.helsinki.cs.tmc.core.io.zipper.unzippingdecider.UNZIP_ALL_THE_THINGS;
import fi.helsinki.cs.tmc.core.io.zipper.unzippingdecider.UnzippingDecider;
...
public class UnzippingDeciderTest {
    ...
    public void setUp() throws Exception {
        projectPath = FileUtil.getUnixPath(FileUtil.append(new File(".").getCanonicalPath(),
                "src/test/java/fi/helsinki/cs/tmc/core/io/unzippingdecider"));
